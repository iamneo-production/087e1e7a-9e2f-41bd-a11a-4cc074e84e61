...
const AddGift = (props) => {
  ...
  const handleAddGift = (event) => {
    ...
    if (!hasErrors) {
      const url = "https://8080-afafecaabdbcabadfbbdfdacbcefeddcbcbaffb.project.examly.io/admin/addGift";
