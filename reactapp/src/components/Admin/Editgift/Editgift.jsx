...
const id = props.giftid;
  ...
  axios.put('https://8080-affdbaabdcabfabadfbbdfdacbcefeddcbcbaffb.project.examly.io/admin/editGift/'+id,data)
  .then(response => {
...
const Editgift = (props) => {
  ...
  const [detailsError, setDetailsError] = useState('');
    ...
    const handleEdit = () => {
      ...
      axios.put('https://8080-dafbecdaebfdaaaabadfbbdfdacbcefeddcbcbaffb.project.examly.io/admin/editGift/' + gift.giftId, data)
        .then(response => {
          if (response.data === "Gift edited") {
            toast.success("Gift Edited");
            handleClose();
