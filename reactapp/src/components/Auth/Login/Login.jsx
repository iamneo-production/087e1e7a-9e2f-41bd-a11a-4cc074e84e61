  ...
  const navigate = useNavigate();
    ...
    const [showPassword, setShowPassword] = useState(false);
      const handleSubmit = (e) => {
        ...
        axios.post("https://8080-fbfbaaaeabebabafdabadfbbdfdacbcfcecaabcfba.project.examly.io/user/login", data)
        .then((result) => {
              if(result.data === "valid"){
                ...
                axios.post("https://8080-fbfbaaaeabebabafdabadfbbdfdacbcfcecaabcfba.project.examly.io/admin/login", data)
                .then((result1) => {
