  ...
  const handleSubmit = (e) => {
    e.preventDefault();
      if (validateForm()) {
        ...
        const url = "https://8080-ecdbffcdccababadfbbdfdacbcefeddcbcbaffb.project.examly.io/user/addUser";
...
<label>Email: </label>
      ...
      <InputGroup>
       <InputGroup.Text> <FiMail /> </InputGroup.Text>
        <Form.Control  type="text" id="email" data-testid="email" placeholder=" Enter Email" onChange={(e) => setEmail(e.target.value)} required />
        </InputGroup>
...
<Form.Group className="mb-3">
  <InputGroup>
    <FormControl
      type={showConfirmPassword ? 'type' : 'password'} id="confirmPassword" data-testid="confirmPassword"
  ...
  {errors.confirmPassword && <span>{errors.confirmPassword}</span>}
          ...
          {passwordError && <span>{passwordError}</span>} {/* Display password error message */}
