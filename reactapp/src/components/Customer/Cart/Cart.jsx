...
const Myorders=()=> {
  ...
  const fetchOrders=()=>{
    axios.get('https://8080-afaebaefbabadfbbdfdacbcfcecaabcfba.project.examly.io/user/getOrdersCart', {
      params: {
        userEmail: email
      }
      }).then((response) => {
  ...
  useEffect(()=>{
    ...
    const navigate = useNavigate();
     ...
     const handlePay=()=>{
      //Add order api
      axios.post('https://8080-afaebaefbabadfbbdfdacbcfcecaabcfba.project.examly.io/user/addOrders', email, {
        headers: {
