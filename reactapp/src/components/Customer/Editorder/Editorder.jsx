...
const EditOrder=(props)=>{ 
  ...
  useEffect(() => {
  //Get themes Api
  axios.get('https://8080-ecaebdccabadfbbdfdacbcfcecaabcfba.project.examly.io/admin/getTheme')
    .then(response => {
...
const handleSubmit=(e)=>{
    e.preventDefault();
      ...
      console.log(order)
      axios.put('https://8080-ecaebdccabadfbbdfdacbcfcecaabcfba.project.examly.io/user/editOrder/'+order.orderID,Orderdata).then((result)=>{
