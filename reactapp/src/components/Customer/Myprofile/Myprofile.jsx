...
const MyProfile = () => {
  ...
  useEffect(() => {
    axios
      .get('https://8080-fbfbaaaeabebabafdabadfbbdfdacbcfcecaabcfba.project.examly.io/user/getuserbyemail', {
        params: {
          email: email
        }
      })
  ...
  const handleUsernameUpdate = (e) => {
    ...
    axios
      .put('https://8080-fbfbaaaeabebabafdabadfbbdfdacbcfcecaabcfba.project.examly.io/user/updateusername', data)
      .then((result) => {
  ...
  const handleMobileNumberUpdate = (e) => {
    ...
    axios
      .put('https://8080-fbfbaaaeabebabafdabadfbbdfdacbcfcecaabcfba.project.examly.io/user/updatemobilenumber', data)
      .then((result) => {
        console.log(result.data);
  ...
  const updatePassword = () => {
    ...
    axios
      .put('https://8080-fbfbaaaeabebabafdabadfbbdfdacbcfcecaabcfba.project.examly.io/user/updatepassword', data)
      .then((result) => {
        console.log(result.data);
  ...
  const handlePasswordUpdate = () => {
    ...
    axios
      .post('https://8080-fbfbaaaeabebabafdabadfbbdfdacbcfcecaabcfba.project.examly.io/user/login', data)
      .then((result) => {
