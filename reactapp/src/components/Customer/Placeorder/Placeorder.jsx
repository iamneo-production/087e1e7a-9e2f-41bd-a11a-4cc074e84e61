...
const [selectedThemes, setSelectedThemes] = useState([]);
  ...
  useEffect(() => {
  //Get themes Api
  axios.get('https://8080-ecdbffcdccababadfbbdfdacbcfcecaabcfba.project.examly.io/admin/getTheme')
    .then(response => {
...
const handleSubmit=(e)=>{
  ...
  e.preventDefault();
    ...
    axios.post('https://8080-ecdbffcdccababadfbbdfdacbcfcecaabcfba.project.examly.io/user/addOrdersCart',Orderdata).then((result)=>{
