  ...
  const navigate = useNavigate();
    ...
    const [password, setPassword] = useState('');
      ...
      const handleSubmit = (e) => {
        ...
        axios.post("https://8080-aeeceaafaebbabadfbbdfdacbcfcecaabcfba.project.examly.io/auth/user/login", data)
        .then((result) => {
              if(result.data === true){
                ...
                axios.post("https://8080-aeeceaafaebbabadfbbdfdacbcfcecaabcfba.project.examly.io/auth/admin/login", data)
                .then((result) => {
                      if(result.data === true){
